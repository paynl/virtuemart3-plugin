...
<table>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_PAYNL_API_PAYMENT_NAME'); ?></td>
	...
	<?php if ($success) { ?>
	<tr>
		<td><?php echo vmText::_('VMPAYMENT_PAYNL_API_AMOUNT'); ?></td>
                <td><?php echo $currency->getSymbol() . ' ' . floatval($amount); ?></td>
    </tr>

	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_PAYNL_API_TRANSACTION_ID'); ?></td>
